...
This repository contains a demonstration of single-cell omics analysis and visualisation in Python.

### What does this project do?
- Loading a small synthetic scATAC-seq dataset
- Preprocessing (normalization, log-transform, select high variable genes)
